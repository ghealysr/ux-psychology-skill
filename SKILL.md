...
### Quick Reference
Ask: "What psychology principles apply to [page type]?"
Returns: 3-5 most relevant principles with one-line application notes.

### Design Review
Ask: "Review this page/component through a psychology lens"
Returns: Which principles are being used (intentionally or not), which opportunities exist, and which anti-patterns to avoid.

### Conversion Flow
Ask: "Design a conversion sequence for [goal]"
Returns: Ordered principle application with rationale.
...
- Fake social proof (fabricated testimonials or numbers)
